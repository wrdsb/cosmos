...
import { FunctionInvocation, FlendersonCommandFunctionRequest, FlendersonCommandFunctionRequestBody, FlendersonJobType, FlendersonCommandOperation, FlendersonCommandFunctionRequestPayload } from '@cosmos/types';
...
const flendersonCommand: AzureFunction = async function (context: Context, req: FlendersonCommandFunctionRequest): Promise<void> {
    ...
    const jobType = requestBody.jobType as FlendersonJobType;
    const operation = requestBody.operation as FlendersonCommandOperation;
    const payload = requestBody.payload as FlendersonCommandFunctionRequestPayload;
...
export default flendersonCommand;
