...
const GoogleGroupsMembershipsOneOffsCalculate: AzureFunction = async function (context: Context, triggerMessage: GoogleGroupsMembershipsOneOffsCalculateFunctionRequest): Promise<void> {
    ...
    const logStorageContainer = 'function-google-groups-memberships-one-offs-calculate-logs';
    ...
    const triggerObject = triggerMessage as GoogleGroupsMembershipsOneOffsCalculateFunctionRequest;
    const payload = triggerObject.payload as GoogleGroupsMembershipsOneOffsCalculateFunctionRequestPayload;
...
export default GoogleGroupsMembershipsOneOffsCalculate;