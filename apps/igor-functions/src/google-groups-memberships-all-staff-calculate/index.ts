...
import { GoogleGroupsMembershipsAllStaffCalculateFunctionRequest, GoogleGroupsMembershipsAllStaffCalculateFunctionRequestPayload } from "@cosmos/types";

const GoogleGroupsMembershipsAllStaffCalculate: AzureFunction = async function (context: Context, triggerMessage: GoogleGroupsMembershipsAllStaffCalculateFunctionRequest): Promise<void> {
    ...
    const logStorageContainer = 'function-google-groups-memberships-all-staff-calculate-logs';
    ...
    const triggerObject = triggerMessage as GoogleGroupsMembershipsAllStaffCalculateFunctionRequest;
    const payload = triggerObject.payload as GoogleGroupsMembershipsAllStaffCalculateFunctionRequestPayload;
...
export default GoogleGroupsMembershipsAllStaffCalculate;