...
import { GoogleGroupsMembershipsABCCalculateFunctionRequest, GoogleGroupsMembershipsABCCalculateFunctionRequestPayload } from "@cosmos/types";

const GoogleGroupsMembershipsABCCalculate: AzureFunction = async function (context: Context, triggerMessage: GoogleGroupsMembershipsABCCalculateFunctionRequest): Promise<void> {
    ...
    const logStorageContainer = 'function-google-groups-memberships-abc-calculate-logs';
    ...
    const triggerObject = triggerMessage as GoogleGroupsMembershipsABCCalculateFunctionRequest;
    const payload = triggerObject.payload as GoogleGroupsMembershipsABCCalculateFunctionRequestPayload;
...
export default GoogleGroupsMembershipsABCCalculate;
