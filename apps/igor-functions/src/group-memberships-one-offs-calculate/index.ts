...
import { GroupMembershipsOneOffsCalculateFunctionRequest, GroupMembershipsOneOffsCalculateFunctionRequestPayload } from "@cosmos/types";
...
const GroupMembershipsOneOffsCalculate: AzureFunction = async function (context: Context, triggerMessage: GroupMembershipsOneOffsCalculateFunctionRequest): Promise<void> {
    ...
    const logStorageContainer = 'function-group-memberships-one-offs-calculate-logs';
