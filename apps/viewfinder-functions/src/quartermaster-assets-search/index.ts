...
import { FunctionInvocation, DeviceLoan } from "@cosmos/types";

const quartermasterAssetsSearch: AzureFunction = async function (context: Context, req: HttpRequest): Promise<void> {
    const functionInvocation = {
        functionInvocationID: context.executionContext.invocationId,
        functionInvocationTimestamp: new Date().toJSON(),
        functionApp: 'Viewfinder',
        functionName: context.executionContext.functionName,
        functionDataType: 'QuartermasterAsset',
    ...
    const searchIndex = 'quartermaster-assets';
    ...
    const searchClient = new SearchClient<DeviceLoan>(
        searchURL,
        searchIndex,
...
export default quartermasterAssetsSearch;
