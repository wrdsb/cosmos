...
const quartermasterAssetFind: AzureFunction = async function (context: Context, req: HttpRequest): Promise<void> {
    ...
    const searchResults = await searchClient.getDocument(documentID);
...
export default quartermasterAssetFind;
