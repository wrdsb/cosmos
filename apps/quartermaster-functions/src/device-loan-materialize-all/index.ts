...
import { FunctionInvocation, DeviceLoanMaterializeFunctionRequest } from "@cosmos/types";

const deviceLoanMaterializeAll: AzureFunction = async function (context: Context, triggerMessage: any): Promise<void> {
    ...
    context.log('Queue all Materialize Device Loans');
    ...
    for (let assetID of allAssetIDs) {
        ...
        } as DeviceLoanMaterializeFunctionRequest);
    }

    context.bindings.deviceLoanMaterialize = queueMessages;
...
export default deviceLoanMaterializeAll;