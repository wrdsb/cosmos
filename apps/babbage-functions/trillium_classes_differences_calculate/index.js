module.exports = function (context, data) {
    ...
    function create_events(differences, callback) {
        ...
        differences.created_records.forEach(function (record) {
            var event_type = "ca.wrdsb.skinner.trillium_class.create";
            var event = {
                eventID: `${event_type}-${context.executionContext.invocationId}`,
                eventType: event_type,
                source: "/trillium/class/{record_id}/create",
                schemaURL: "ca.wrdsb.skinner.trillium_class.create.json",
                extensions: {
                    app: 'wrdsb-babbage',
                    label: "skinner creates trillium_class",
                    tags: [
                        "skinner",
                        "trillium",
                        "trillium_class",
        ...
        differences.updated_records.forEach(function (record) {
            var event_type = "ca.wrdsb.skinner.trillium_class.update";
            var event = {
                eventID: `${event_type}-${context.executionContext.invocationId}`,
                eventType: event_type,
                source: "/trillium/class/{record_id}/update",
                schemaURL: "ca.wrdsb.skinner.trillium_class.update.json",
                extensions: {
                    label: "skinner updates trillium_class",
                    tags: [
                        "skinner",
                        "trillium",
                        "trillium_class",
        ...
        differences.deleted_records.forEach(function (record) {
            var event_type = "ca.wrdsb.skinner.trillium_class.delete";
            var event = {
                eventID: `${event_type}-${context.executionContext.invocationId}`,
                eventType: event_type,
                source: "/trillium/class/{record_id}/delete",
                schemaURL: "ca.wrdsb.skinner.trillium_class.delete.json",
                extensions: { 
                    label: "skinner deletes trillium_class", 
                    tags: [
                        "skinner", 
                        "trillium", 
                        "trillium_class", 
        ...
        var event_type = "ca.wrdsb.babbage.trillium_classes_differences.calculate";
        var flynn_event = {
            eventID: `${event_type}-${context.executionContext.invocationId}`,
            eventType: event_type,
            source: "/trillium/classes/differences/calculate",
            schemaURL: "ca.wrdsb.babbage.trillium_classes_differences.calculate.json",
            extensions: { 
                app: 'wrdsb-babbage',
                label: "babbage calculates trillium_classes_differences", 
                tags: [
                    "babbage", 
                    "trillium", 
                    "trillium_classes_differences", 
                    "differences", 
                    "calculate"
                ] 
            },
