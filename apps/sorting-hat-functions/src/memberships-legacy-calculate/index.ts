...
import { MembershipsLegacyCalculateFunctionRequest, MembershipsLegacyCalculateFunctionRequestPayload } from "@cosmos/types";

const membershipsLegacyCalculate: AzureFunction = async function (context: Context, triggerMessage: MembershipsLegacyCalculateFunctionRequest): Promise<void> {
