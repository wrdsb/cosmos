...
const viewGClassroomCopyPoison: AzureFunction = async function (context: Context, triggerMessage: string): Promise<void> {
...
export default viewGClassroomCopyPoison;
