export type WALDIRJobType =
'WRDSB.WALDIR.WPUser.Get' |
...
'WRDSB.WALDIR.WPUser.ChangeParse' |

'WRDSB.WALDIR.WALDIRUser.Materialize' |
'WRDSB.WALDIR.WALDIRUser.MaterializeBatch' |

'WRDSB.WALDIR.NotificationEmail.Send' |
'WRDSB.WALDIR.SearchIndexer.Invoke';
